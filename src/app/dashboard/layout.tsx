...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-200">
      ...
      {/* Global Drag Overlay */}
      {isGlobalDragging && (
        <div className="fixed inset-0 z-[99] bg-indigo-950/20 dark:bg-black/60 backdrop-blur-xs flex items-center justify-center p-6 pointer-events-none">
          <div className="max-w-md w-full bg-card/95 dark:bg-zinc-900/95 border-2 border-dashed border-indigo-500 rounded-2xl p-8 text-center space-y-4 shadow-2xl animate-pulse">
