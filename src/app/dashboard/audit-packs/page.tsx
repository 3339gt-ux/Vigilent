    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          <p>Generated by Vygilence for ${escapeHtml(organization?.name || 'Organisation Workspace')} on ${new Date().toLocaleString('en-GB')}. Document files must be opened inside Vygilence using temporary signed URLs.</p>
          <table>
            <thead>
              <tr>
                <th>Requirement</th>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-border p-4 rounded-xl text-xs space-y-3">
            ...
            <p className="text-[10px] text-muted-foreground leading-relaxed">
              Packs store requirement IDs and linked document IDs only. Documents remain in private storage and must be opened from inside Vygilence.
            </p>
