    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          <p>Generated by Vygilence from selected requirements and linked private evidence records. Document files must be opened inside Vygilence using temporary signed URLs.</p>
          <table>
            <thead>
              <tr>
                <th>Requirement</th>
