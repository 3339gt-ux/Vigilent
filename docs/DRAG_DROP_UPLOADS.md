...
Vygilence uses a shared `EvidenceDropzone` component for drag-and-drop and multi-file upload surfaces. The component is a UI and queue layer only; it does not create a separate upload backend.
