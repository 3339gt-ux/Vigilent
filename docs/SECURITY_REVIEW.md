...
- Password recovery has a native callback form that requires a valid Supabase recovery session; the complete email/link/update/sign-in journey still requires staging verification.
